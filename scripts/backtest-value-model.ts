...
//
// Usage:
//   npx tsx scripts/backtest-value-model.ts --data <dump.json> [--scoring-format half]
//   PB_SUPERUSER_EMAIL=... PB_SUPERUSER_PASSWORD=... npx tsx scripts/backtest-value-model.ts [--scoring-format ppr]

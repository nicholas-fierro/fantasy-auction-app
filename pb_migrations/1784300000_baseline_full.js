...
migrate((app) => {
  const snapshot = [
    ...
    {
      "id": "pbc_2345463699",
      "listRule": "auction_id.user = @request.auth.id || auction_id.league.commissioner = @request.auth.id || (auction_id.type = \"official\" && auction_id.league.league_members_via_league.user ?= @request.auth.id) || (auction_id.type = \"official\" && auction_id.external = true)",
      "viewRule": "auction_id.user = @request.auth.id || auction_id.league.commissioner = @request.auth.id || (auction_id.type = \"official\" && auction_id.league.league_members_via_league.user ?= @request.auth.id) || (auction_id.type = \"official\" && auction_id.external = true)",
    ...
    {
      "id": "pbc_848867609",
      "listRule": "user = @request.auth.id || league.commissioner = @request.auth.id || (type = \"official\" && league.league_members_via_league.user ?= @request.auth.id) || (type = \"official\" && external = true)",
      "viewRule": "user = @request.auth.id || league.commissioner = @request.auth.id || (type = \"official\" && league.league_members_via_league.user ?= @request.auth.id) || (type = \"official\" && external = true)",
